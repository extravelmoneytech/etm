<section class="flex flex-col mt-24 customMd:mt-60 px-5 sm:px-12 md:px-24">
                <div class="mt-10  flex-col gap-2 flex sm:hidden">
                ...
                <p class="text-black text-center text-lg font-semibold mt-12 sm:mt-0">6000 + RBI Authorized Exchange Houses on the Platform.</p>
