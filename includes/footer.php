                ...
                <div class="flex flex-col justify-center items-start gap-4">
                    <div class="flex flex-col justify-center customMd:justify-between items-start gap-4 customMd:flex-row w-full">
                        ...
                        <div class="flex gap-2 justify-between w-full customMd:w-1/3">
                            ...
                            <a target="_blank" href="https://www.extravelmoney.com/blog/" class="border-[#0e51a0] border rounded-3xl px-4 py-1 text-primary-blue text-sm">Blogs</a>
                            <a href="<?php echo $fold .'coming-soon'; ?>" class="border-[#0e51a0] border rounded-3xl px-4 py-1 text-primary-blue text-sm">Offers</a>
                            <a href="<?php echo $fold .'coming-soon'; ?>" class="border-[#0e51a0] border rounded-3xl px-4 py-1 text-primary-blue text-sm">Tools</a>
                            <a href="<?php echo $fold .'coming-soon'; ?>" class="border-[#0e51a0] border rounded-3xl px-4 py-1 text-primary-blue text-sm">FAQ</a>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-4 mt-6 customMd:mt-12 customMd:flex-row w-full justify-between">
                        ...
                        <div class="flex flex-col">
                            ...
                            <ul class="flex flex-col gap-1 list-disc">
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">About US</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Partner Login</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Live Rates</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Buy Forex</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Forex Rates Today</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">TCS Calculator</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Currency Converter</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Remittance Limits</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Forex Partners</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Privacy Policy</a></li>
                                <li class="text-black/60 text-sm ml-5"><a href="<?php echo $fold .'coming-soon'; ?>">Terms of Service</a></li>
                        ...
                        <div class="flex flex-col">
                            ...
                            <ul class="flex flex-col gap-1">
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-usa'; ?>">Send Money to USA</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-australia'; ?>">Send Money to Australia</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-canada'; ?>">Send Money to Canada</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-uk'; ?>">Send Money to UK</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-new-zealand'; ?>">Send Money to New Zealand</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-germany'; ?>">Send Money to Germany</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-france'; ?>">Send Money to France</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-singapore'; ?>">Send Money to Singapore</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-europe'; ?>">Send Money to Europe</a></li>
                                <li class="text-black/60 text-sm"><a href="<?php echo $fold .'wire-transfer/send-money-to-uae'; ?>">Send Money to UAE</a></li>
                        ...
                        <div class="flex flex-col">
                            ...
                            <ul class="flex flex-col gap-1">
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Bangalore</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Chennai</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Delhi</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Mumbai</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Hyderabad</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Kolkata</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Pune</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Noida</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Ahmedabad</a></li>
                                <li class="text-black/60 text-sm"><a href="">Currency Exchange in Chandigarh</a></li>
                    ...
                    <div class="flex-col flex mt-8">
                        <p class="text-black/60 pb-4 border-b border-black/10 text-mediumFont">All currency exchange, forex card and international remittance transactions are processed by our partner RBI-authorized money changers and banks as prescribed by the Reserve Bank of India.</p>
