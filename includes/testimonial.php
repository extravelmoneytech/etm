<section class="mt-16 px-5 sm:px-12 md:px-24 pb-8">
                <div class="flex justify-between items-end">
                    <div class="flex flex-col gap-4">
                        <h2 class="text-black text-3xl font-bold ">Our User Kind Words</h2>
                        <div class="text-[#90a3bf] text-base font-normal max-w-[33rem]">Here are some testimonials from our user after using  Extravelmoney.com to manage their business  expenses.</div>
                    </div>
