                ...
                <div class="px-5 sm:px-12 md:px-16 py-5">
                    ...
                    <div class="flex flex-col md:flex-row md:gap-16  md:border border-primary-blue/10 rounded-2xl md:p-8">
                        ...
                        <div class="flex w-full md:w-2/5 flex-col mt-6">
                            ...
                            <p class="text-black/60 text-sm font-semibold forexContainer">Book now & Pay later</p>
                            <p class="text-black/60 text-sm font-semibold moneyT">Select Payment Method</p>
                             ...
                             <div class="flex flex-col gap-2 forexContainer">
                                <div id=""
                                    ...
                                    <div class="justify-start items-center gap-2 inline-flex">
                                        ...
                                        <p class=" text-sm font-semibold">Order Forex</p>
                                    </div>
                            ...
                            <div class="text-black/60 text-xs font-normal mt-10"><span>By proceeding I agree to the </span><span class="underline">Terms & Conditions</span><span> and </span><span class="underline">Cancellation & Refund Policy</span><span> of ExTravelmoney Technosol Pvt. Ltd.</span></div>
