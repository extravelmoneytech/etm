            ...
            <section class="md:flex px-5 sm:px-12 md:px-24 py-5 gap-6 md:mt-16">
                <div class="w-full md:w-3/5 border-[#0e51a0]/10 rounded-2xl md:border md:px-8 md:pb-4">
                    ...
                    <div class="w-full progressBar justify-start items-center gap-2 inline-flex mt-6 md:hidden">
                        ...
                        <div class="text-black text-base font-bold leading-none">Delivery Details</div>
                        ...
                        <div class="flex flex-col mt-4 pb-6">
                            ...
                            <div class="px-2 ">
                                <div class="h-7 justify-start items-center gap-1 inline-flex">
                                    <p class="text-black/60 text-[13px] font-normal ">Choose Nearest Branch in</p>
                ...
                <div class="flex-col w-full md:w-1/3 border-black/10 mt-6 customMd:mt-0">
                    ...
                    <div
                        class="flex  customGradient3 z-20 rounded-tr-2xl rounded-tl-2xl p-2 justify-between items-center gap-2">

                        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 26 27" fill="none">
                        ...
                        <div id="cartContent">
                            ...
                            <span class="text-white text-xs font-normal  leading-[18px]">of your product by </span>
...
<script src="<?php echo $fold . 'scripts/pageScripts/deliveryDetails.js'; ?>"></script>
